...
def test_build_configured_g2b_collector_falls_back_to_legacy_common_key() -> None:
    settings = Settings(data_go_kr_service_key="legacy-key", g2b_service_key=None)
...
def test_build_configured_g2b_collector_accepts_source_specific_key_without_legacy() -> None:
    settings = Settings(data_go_kr_service_key=None, g2b_service_key="source-specific-key")
...
def test_build_configured_g2b_collector_rejects_missing_key() -> None:
    settings = Settings(data_go_kr_service_key=None, g2b_service_key=None)
